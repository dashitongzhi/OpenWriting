...
swift_files=(
  ...
  "$REPO_ROOT/OpenWriting/ProjectDocumentCodec.swift"
  "$REPO_ROOT/OpenWriting/LegacyProjectSidecarMigrator.swift"
  "$REPO_ROOT/OpenWriting/ProjectPersistenceActor.swift"
  "$REPO_ROOT/OpenWriting/ProjectStorageHealth.swift"
